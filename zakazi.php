...
<div class="container-fluid sec2">
     ...
     <div style="padding-bottom: 500px;" class="blur"> 
      ...
      <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0a23355e;">
        ...
        <h1 style="margin-top: 100px;color:beige" class="text-center">Все заказы</h1>
...
$result=mysqli_query($connection,"SELECT * FROM `zakazi`");
...
while(($cat=mysqli_fetch_assoc($result)))
{
  ...
  echo '<td>'. $cat['Buyer']. '</td>';
  echo '<td>'. $cat['Medicaments']. '</td>';
  echo '<td>'. $cat['Kassir']. '</td>';
